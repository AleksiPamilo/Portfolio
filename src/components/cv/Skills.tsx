            ...
            <div className="mt-5 p-4 flex flex-wrap justify-center gap-5">
                {
                    !skills
                        ...
                        : skills.map((x) => (
                            <div key={x.key} className="flex rounded-lg w-[20rem] h-[5rem] p-4 bg-black select-none border border-cyan-400 box-shadow">
                                <div className="w-full">
                                    ...
                                    <div className="relative mt-4 w-full h-[6px] bg-gray-600 rounded-lg">
