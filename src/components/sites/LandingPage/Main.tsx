...
const LandingPage: React.FC = () => {
  ...
  return (
    <div className="select-none md:ml-60 md:mt-44 ml-5 mt-12">
      ...
      <Link to="/projects" className="inline-block py-3 px-4 w-[250px] rounded-lg text-center border-2 text-cyan-600 border-cyan-600 mr-3 mb-3">Check out my projects!</Link>
      <Link to="/cv" className="inline-block py-3 px-4 w-[250px] rounded-lg text-center border-2 text-cyan-600 border-cyan-600 mr-3">Check out my CV!</Link>
    </div>
  )
}
